 ...
 * @subpackage Planningscroller/admin/views
 */
...
class PlanningViewCreate {
	...
	public static function planning_display() 
	{
		...
		<div class="sy-admin-container">
			<h1><?php _e( 'Planning - Générer un planning', 'planning' ); ?></h1>
				...
				<form id="newone" method="POST" action="">
					...
					<div class="forminput">
						<div class="labeldecadix">
							<label  for="p_name"><?php _e( 'Titre', 'planning' ); ?></label>
						</div>
						<input id="p_name" type="text" placeholder="<?php _e( 'Entrer un titre', 'planning' ); ?>" name="p_name" value="">
					</div>
					<input id="planning_id" type="hidden" name="planning_id" value="">
					<div class="forminput">
						<div class="labeldecadix">
							<label for="time_mode"><?php _e( 'Type d\'heure', 'planning' ); ?></label>
						</div>
						<select id="time_mode" name="time_mode">
							<option value="0"><?php _e( '24h', 'planning' ); ?></option>
							<option value="1"><?php _e( '12h', 'planning' ); ?></option>
						</select>
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="type"><?php _e( 'Type', 'planning' ); ?></label>
						</div>
						<select id="type" name="type">
							<option value="0" selected><?php _e( 'Fixe', 'planning' ); ?></option>
							<option value="1" disabled><?php _e( 'Adaptatif', 'planning' ); ?></option>
						</select>
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="display_title"><?php _e( 'Affichage du titre', 'planning' ); ?></label>
						</div>
						<select id="display_title" name="display_title">
							<option value="0"><?php _e( 'Non', 'planning' ); ?></option>
							<option value="1" selected><?php _e( 'Oui', 'planning' ); ?></option>
						</select>
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="display_filters"><?php _e( 'Affichage des filtres', 'planning' ); ?></label>
						</div>
						<select id="display_filters" name="display_filters">
							<option value="0" selected><?php _e( 'Non', 'planning' ); ?></option>
							<option value="1" disabled><?php _e( 'Oui', 'planning' ); ?></option>
						</select>
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="start_h"><?php _e( 'Heure de début', 'planning' ); ?></label>
						</div>
						<input id="start_h" class="start_h" type="text" placeholder="Heure de début" name="start_h" value="">
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="rows"><?php _e( 'Colonnes', 'planning' ); ?></label>
						</div>
						<input id="rows" type="number" name="rows" max="7"  placeholder="columns" value="5">
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="cells"><?php _e( 'Cellules', 'planning' ); ?></label>
						</div>
						<input id="cells" type="number" name="cells" max="10" placeholder="Cells" value="8">
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="height"><?php _e( 'Hauteur', 'planning' ); ?></label>
						</div>
						<input id="height" type="number" name="height" min="50" value="60">
					</div>
					<div class="forminput cellcolor">
						<div class="labeldecadix">
							<label for="cell_color"><?php _e( 'Couleur de cellule', 'planning' ); ?></label>
						</div>
						<input id="cell_color" type="text" name="cell_color" value="f5f5f5">
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="rows_name"><?php _e( 'Personalisation du nom de la colonne', 'planning' ); ?></label>
						</div>
						<textarea form="newone" id="rows_name" name="rows_name" placeholder="<?php _e( 'Entrer les noms en les séparant par une virgule', 'planning' ); ?>"></textarea>
					</div>
					<div class="forminput description">
						<div class="labeldecadix">
							<label for="description"><?php _e( 'Description', 'planning' ); ?></label>
						</div>
						<textarea form="newone" id="description" name="description" placeholder="<?php _e( 'Entrer une description', 'planning' ); ?>"></textarea>
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="print"><?php _e( 'Impression', 'planning' ); ?></label>
						</div>
					...
					<div class="forminput">
						<div class="labeldecadix">
							<label class="editortip" for="editor" data-tooltip-content=".syet_role_tooltip_free"><?php _e( 'Editeur', 'planning' ); ?><i>
					...
					<div class="sy-form-button">
					  	<a class="exitButton" id="et_exit" href="admin.php?page=planning"><?php _e( 'Quiter', 'planning' ); ?></a>
					  	<input class="saveButton" id="et_save" type="submit" value="<?php _e( 'Sauvegarder', 'planning' ); ?>" >
				  	</div>
				</form>	
			</div>
		</div>
		<div style="display:none">
			<div class="syet_role_tooltip_free"><?php _e( '<strong>Extended version feature.</strong><br/>Only an Administrator can attribute a schedule to a user. <br/>An Administrator can always edit the schedule. <br/>If schedule creation is allowed to a lower access role, the user who creates the schedule is by default the manager of this schedule.', 'planning' ); ?></div>
			<div class="syet_role_tooltip"><?php _e( 'Only an Administrator can attribute a schedule to a user. <br/>An Administrator can always edit the schedule. <br/>If schedule creation is allowed to a lower access role, the user who creates the schedule is by default the manager of this schedule.', 'planning' ); ?></div>
		</div>
	...
	{
		add_action("admin_enqueue_scripts", "planning_my_media_gallery_to_insert_in_activity");
		global $wp_roles;
	    $roles = $wp_roles->get_names();
	    global $wp_locale;
	    $wkTtStart = (int)get_option("start_of_week");
	...
	?>
			...
			<h1><?php printf(__( 'Planning - Editer le planning - %s', 'planning' ), esc_html($data[0]->p_name)); ?></h1>
			<div class="sy-configuration button"><?php _e( 'Configuration du planning', 'planning' ); ?></div>
			<div id="create" class="createnew button"><?php _e( 'Créer une nouvelle activité', 'planning' ); ?></div>
			<div id="sydays" class="daysbutton button"><?php _e( 'Jours', 'planning' ); ?></div>			
			<div class="ultimate-submit button" data-changes="0">
				<label for="et_modify"><?php _e( 'Sauvegarder', 'planning' ); ?></label><div class="preloader" style="display:none;"><img src="<?php echo plugins_url( 'images/loading.png', __FILE__ ); ?>"></div>
			</div>
			<div id="sy-exit" class="sy-exit button"><a href="admin.php?page=planning" target="_self"><?php _e( 'Quitter', 'planning' ); ?></a></div>
			<div class="sy-form-container">
				<h3><?php _e( 'Configuration du planning', 'planning' ); ?></h3>
				<form id="newone" name="newone" method="POST" action="">
					...
					<div class="forminput">
						...
						<input id="p_name" class="p_name" type="text" name="p_name" placeholder="<?php _e( 'Entrer un titre', 'planning' ); ?>" value="<?php echo $data[0]->p_name ?>">
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="time_mode"><?php _e( 'Mode de temps', 'planning' ); ?></label>
						</div>
						<select id="time_mode" class="time_mode" name="time_mode" disabled>
							<?php if( $data[0]->time_mode == 0): ?>
								<option value="0" selected><?php _e( '24h', 'planning' ); ?></option>
								<option value="1"><?php _e( '12h', 'planning' ); ?></option>
							<?php else: ?>
								<option value="0"><?php _e( '24h', 'planning' ); ?></option>
								<option value="1" selected><?php _e( '12h', 'planning' ); ?></option>
							<?php endif ?>
						</select>
					</div>
					<div class="forminput">
						...
						<select id="type" class="sy-type" name="type" disabled>
							<?php if( $data[0]->type == 0): ?>	
								<option value="0" selected><?php _e( 'Fixe', 'planning' ); ?></option>
								<option value="1"><?php _e( 'Adapté', 'planning' ); ?></option>	
							<?php else: ?>
								<option value="0"><?php _e( 'Fixe', 'planning' ); ?></option>
								<option value="1" selected><?php _e( 'Adapté', 'planning' ); ?></option>
							<?php endif ?>
						</select>
					</div>
					<div class="forminput">
						...
						<select id="display_title" class="display-title" name="display_title">
							<?php if( $data[0]->display_title == 0): ?>
								<option value="0" selected><?php _e( 'Non', 'planning' ); ?></option>
								<option value="1"><?php _e( 'Oui', 'planning' ); ?></option>
							<?php else: ?>
								<option value="0"><?php _e( 'Non', 'planning' ); ?></option>
								<option value="1" selected><?php _e( 'Oui', 'planning' ); ?></option>
							<?php endif ?>
					...
					<div class="forminput">
						<div class="labeldecadix">
							<label for="start_h"><?php _e( 'Heure de départ', 'planning' ); ?></label>
						</div>
						<input id="start_h" class="start_h" type="text" name="start_h" placeholder="<?php _e( 'Heure de départ', 'planning' ); ?>" value="<?php echo $data[0]->start_h ?>">
					</div>
					<div class="forminput">
						<div class="labeldecadix">
							<label for="rows"><?php _e( 'Colonnes', 'planning' ); ?></label>
					...
					<div class="forminput">
						<div class="labeldecadix">
							<label for="rows_name"><?php _e( 'Noms de colonne', 'planning' ); ?></label>
						</div>
						<textarea form="newone" id="rows_name" rows="2" cols="45" name="rows_name" placeholder="<?php _e( 'Entrer les noms en séparant d\'une virgule', 'planning' ); ?>"><?php echo esc_html($data[0]->rows_name) ?></textarea>
					</div>
					<div class="forminput description">
						<div class="labeldecadix">
							<label for="description"><?php _e( 'Description', 'planning' ); ?></label>
					...
					<input id="saveSecurity" type="hidden" name="saveSecurity" value="<?php echo esc_html($ajax_nonce) ?>">
					<div class="forminput">
					  	<input id="et_modify" name="et_modify" type="submit" value="<?php _e( 'Sauver', 'planning' ); ?>" style="display:none;">
			...
			<?php if (esc_html($data[0]->type) == 0): ?>
				<div class="timetable-container">
			    	...
			    	<div class="variation-option">
			    		<div id="period-settings" class="periodbutton button"><?php _e( 'Periode', 'planning' ); ?></div>
			    		<div id="add-variation" class="addvariation button" data-tooltip-content=".variation-extended"><?php _e( '+', 'planning' ); ?></div>
			    		<div id="prev-variation" data-current="0" class="prevvariation button" style="display:none;"><?php _e( 'Précédent', 'planning' ); ?></div>
			    		<div id="next-variation" data-current="0" class="nextvariation button" style="display:none;"><?php _e( 'Suivant', 'planning' ); ?></div>
			    	</div>
			...
			<?php endforeach ?>
				<div class="sy-text-script">
					<div class="sy-easy-title"><?php _e( 'Titre', 'planning' ); ?></div>
					<div class="sy-text-save"><?php _e( 'Sauver', 'planning' ); ?></div>
					<div class="sy-text-cancel"><?php _e( 'Quitter', 'planning' ); ?></div>
					<div class="sy-text-apply"><?php _e( 'Appliquer', 'planning' ); ?></div>
					<div class="sy-text-weeks"><?php _e( 'Semaines', 'planning' ); ?></div>
					<div class="sy-help-weeks"><?php _e( 'Reste appuyer sur CTRL pour selectionner/deselectionner manuellement le nombre de semaines', 'planning' ); ?></div>
					<div class="sy-text-edit"><?php _e( 'Editer', 'planning' ); ?></div>
					<div class="sy-text-yes"><?php _e( 'Oui', 'planning' ); ?></div>
					<div class="sy-text-no"><?php _e( 'Non', 'planning' ); ?></div>
					<div class="sy-new-schedule-variation"><?php _e( 'Ajouter une nouvelle variation de planning', 'planning' ); ?></div>
					<div class="sy-want-to-leave"><?php _e( 'Etes vous sur de vouloir quitter ?', 'planning' ); ?></div>
					<div class="sy-display-period"><?php _e( 'Configurer l\'affichage de la période', 'planning' ); ?></div>
					<div class="sy-empty-schedule"><?php _e( 'Planning vide', 'planning' ); ?></div>
					<div class="sy-copy-current"><?php _e( 'Copier ce planning', 'planning' ); ?></div>
					<div class="sy-please-choose"><?php _e( 'Choisir une option', 'planning' ); ?></div>
					<div class="prev-variation"><?php _e( 'Précédent', 'planning' ); ?></div>
		    		<div class="next-variation"><?php _e( 'Suivant', 'planning' ); ?></div>
					<div class="sy-display-period"><?php _e( 'Configurer l\'affichage de la période', 'planning' ); ?></div>
					<div class="sy-option-to-delete"><?php _e( 'Choisir une option pour supprimer', 'planning' ); ?></div>
					<div class="sy-option-to-delete1"><?php _e( 'Supprimer une activité ou les activité du planning', 'planning' ); ?></div>
					<div class="sy-option-to-delete2"><?php _e( 'Supprimer les activités dans ce planning seulement', 'planning' ); ?></div>
					<div class="sy-option-period0"><?php _e( 'Choisir une option', 'planning' ); ?></div>
					<div class="sy-option-period1"><?php _e( 'Semaines paires', 'planning' ); ?></div>
					<div class="sy-option-period2"><?php _e( 'Semaines impaires', 'planning' ); ?></div>
					<div class="sy-option-period3"><?php _e( 'Pas de répétition', 'planning' ); ?></div>
					<div class="sy-option-period4"><?php _e( 'Toutes les semaines', 'planning' ); ?></div>
					<div class="sy-period-help"><?php _e( 'Rester appuyer sur CTRL + cliquer pour selectionner/déselectionner une semaine manuellement', 'planning' ); ?></div>
					<div class="sy-easy-duration"><?php _e( 'Durée', 'planning' ); ?></div>
					<div class="sy-easy-bgcolor"><?php _e( 'BG couleur', 'planning' ); ?></div>
					<div class="sy-easy-bgovercolor"><?php _e( 'BG plus de couleur', 'planning' ); ?></div>
					<div class="sy-easy-fontcolor"><?php _e( 'Police couleur', 'planning' ); ?></div>
					<div class="sy-easy-fontovercolor"><?php _e( 'Police plus de couleur', 'planning' ); ?></div>
					<div class="sy-easy-chooseimage"><?php _e( 'Choisis une image', 'planning' ); ?></div>
					<div class="sy-easy-linkdescription"><?php _e( 'Lien pour la description', 'planning' ); ?></div>
					<div class="sy-easy-imagetooltip"><?php _e( 'Image en info-bulle', 'planning' ); ?></div>
					<div class="sy-easy-tooltiptext"><?php _e( 'Texte info-bulle', 'planning' ); ?></div>
					<div class="sy-easy-textinthecell"><?php _e( 'Texte dans la cellule', 'planning' ); ?></div>
					<div class="sy-easy-description"><?php _e( 'Description', 'planning' ); ?></div>
					<div class="sy-easy-placeholderdescription"><?php _e( 'Entrer une description (optionnel)', 'planning' ); ?></div>
					<div class="sy-easy-helptootip"><?php _e( 'Pas de HTML', 'planning' ); ?></div>
					<div class="sy-easy-helptextincell"><?php _e( 'Will be displayed only if there is enough place in the activity\'s cell<br>Adjust cell\'s height if needed in "Timetable configuration"<br>HTML allowed in the Extended edition', 'planning' ); ?></div>
					<div class="sy-easy-tooltipplaceholder"><?php _e( 'Enter the text displayed when the mouse enters the activity\'s cell (optional).', 'planning' ); ?></div>
					<div class="sy-easy-textincellplaceholder"><?php _e( 'Enter the text to be displayed inside the cell (optional)', 'planning' ); ?></div>
		...
		function planning_my_media_gallery_to_insert_in_activity(data) {
			jQuery.post(ajaxurl, data, function(responseText) {
				url: MyAjax.ajaxurl,
				//ON affiche le planning dans la div globale
		...
		var mediaData = {'action': 'planning_my_media_gallery_to_insert_in_activity'};
		planning_my_media_gallery_to_insert_in_activity(mediaData);
...
/**************************************************************/
	...
	public static function planning_afterSave($id) 
	{
		echo $id;
	}
	public static function planning_displayToo() 
	{
		?>
		<div class="sy-admin-container">
			<h1><?php _e( 'EasyTimetable - Generate a schedule', 'planning' ); ?></h1>
			<h3>
			...
			<p>More informations about the Extended version<br>
				<a class="page-title-action button" style="text-align:center;" href="http://www.stereonomy.com/wordpress-products/easytimetable-plugin-for-wordpress/item/easytimetable-extended-for-wordpress" target="_blank"><?php _e( 'Buy it now!', 'planning' ); ?></a>
			</p>
		</div>
		<?php
	}
